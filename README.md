...
**Progress Update: (2 Apr 2023)**
*   All typeset code blocks through Chapter 7 are written
*   All code through Chapter 6, and some of Chapter 7 is tested
*   Most of Chapter 8 is written (MultilinearValueFunction and SimplexValueFunction need to be finished)
*   Chapter 9 is written
*   Most of Chapter 10 is written (EvolutionStrategies and IsotropicEvolutionStrategies need to be finished)
*   Selected examples and exercises through Chapter 7 are included
